// data.ts
import { User, Media, Post, Comment, Notification, Conversation, Message, Playlist, Thread, StudioProject, Team, ActivityNotification, Task, File as ProjectFile, StudioProjectMessage, PortfolioProject } from './types';
...
export const sampleReplies: Reply[] = [
    { id: 'r1', author: users.user2, content: '좋은 생각이네요! 저도 로파이 트랙에 보컬을 찾고 있었어요.', createdAt: '2023-11-01T10:00:00Z', votes: { up: 5, down: 0 } },
    { id: 'r2', author: users.user4, content: '흥미롭네요. 어떤 분위기를 생각하고 계신가요?', createdAt: '2023-11-01T11:00:00Z', votes: { up: 2, down: 0 }, parentReplyId: 'r1', replies: [
        { id: 'r3', author: users.user2, content: '아주 차분하고 멜랑콜리한 느낌이요.', createdAt: '2023-11-01T12:00:00Z', votes: { up: 1, down: 0 } }
    ]},
];

export const sampleThreads: Thread[] = [
    { id: 't1', title: '신스웨이브 트랙에 보컬 구합니다', content: '새로운 연주곡에 힘 있는 여성 보컬이 필요합니다. The Midnight이나 Gunship 같은 느낌을 생각하고 있어요. 관심 있으시면 DM 주세요!', author: users.user1, category: 'collaboration', createdAt: '2023-11-01T09:00:00Z', votes: { up: 25, down: 2 }, replies: sampleReplies, viewCount: 1200, tags: ['보컬', '신스웨이브', '콜라보'], isPinned: true, collaborationDetails: { roles: ['보컬리스트'], compensation: '수익 분배' } },
    { id: 't2', title: '11월 로파이 챌린지: "비 오는 밤"', content: '이달의 챌린지는 비 오는 밤의 감성을 담은 로파이 트랙 만들기입니다. 마감은 11월 30일!', author: users.user2, category: 'challenge', createdAt: '2023-11-01T08:00:00Z', votes: { up: 50, down: 1 }, replies: [], viewCount: 2500, tags: ['챌린지', '로파이'], isPinned: true },
    { id: 't3', title: '제 새 하이퍼팝 트랙 믹스 피드백 부탁드려요', content: '여러분, 방금 새 트랙 믹스를 마쳤습니다. 킥 드럼 소리가 너무 큰가요? 의견을 들려주세요!', author: users.user3, category: 'feedback', createdAt: '2023-10-31T15:00:00Z', votes: { up: 15, down: 0 }, replies: [], viewCount: 800, tags: ['피드백', '믹싱', '하이퍼팝'], attachment: posts[2] },
    { id: 't4', title: '사이드체인 컴프레션은 어떻게 사용하나요?', content: '안녕하세요, 프로듀싱 초보입니다. 킥과 베이스를 분리하기 위해 사이드체인 컴프레션을 사용하는 방법을 다들 어떻게 하시나요? Ableton Live를 사용 중인데, 자세한 튜토리얼이나 팁이 있을까요?', author: users.user4, category: 'general', createdAt: '2023-10-30T11:00:00Z', votes: { up: 18, down: 0 }, replies: [], viewCount: 950, tags: ['사이드체인', '프로듀싱', 'Ableton', '질문'] },
    { id: 't5', title: '새로운 AI 음악 생성기 "Udio"에 대한 생각', content: '최근에 Udio를 사용해봤는데, 결과물의 품질에 정말 놀랐습니다. Suno와 비교해서 어떤 장단점이 있다고 생각하시나요? 여러분의 경험을 공유해주세요.', author: users.user5, category: 'general', createdAt: '2023-10-29T18:00:00Z', votes: { up: 42, down: 3 }, replies: [], viewCount: 1800, tags: ['Udio', 'AI음악', '토론'] },
    { id: 't6', title: '요즘 유행하는 음악 트렌드는 무엇일까요?', content: '최근 음악 씬에서 어떤 장르나 스타일이 떠오르고 있다고 느끼시나요? 저는 저지 클럽(Jersey Club) 리듬이 점점 더 많이 들리는 것 같아요.', author: users.user1, category: 'general', createdAt: '2023-10-28T14:00:00Z', votes: { up: 33, down: 1 }, replies: [], viewCount: 1500, tags: ['트렌드', '저지클럽', '토론'] },
    { id: 't7', title: '제 새 앰비언트 트랙 "떠다니는 질감" 공유합니다', content: '최근에 작업한 앰비언트 트랙입니다. 명상이나 휴식 시간에 듣기 좋게 만들어봤어요. 들어보시고 감상평 남겨주시면 감사하겠습니다!', author: users.user4, category: 'showcase', createdAt: '2023-10-27T10:00:00Z', votes: { up: 60, down: 0 }, replies: [], viewCount: 1900, tags: ['앰비언트', '작품공유', '신곡'], attachment: posts[3] },
    { id: 't8', title: '영화음악풍 트랙 만들어봤어요!', content: '장엄한 전투씬을 상상하며 만든 시네마틱 트랙입니다. 여러분은 어떤 장면이 떠오르시나요?', author: users.user5, category: 'showcase', createdAt: '2023-10-26T16:00:00Z', votes: { up: 80, down: 2 }, replies: [], viewCount: 2200, tags: ['시네마틱', '오케스트라', '작품공유'], attachment: posts[4] },
];
...
const projectTasks: Task[] = [
    { id: 'task1', title: '메인 멜로디 작성', status: 'completed', priority: 'high', dueDate: '2024-06-10', assignees: [users.user1], description: '코러스의 메인 신스 리드를 작곡합니다.', comments: [] },
    { id: 'task2', title: '베이스라인 녹음', status: 'in-progress', priority: 'high', dueDate: '2024-06-12', assignees: [users.user2], description: '그루비한 베이스라인을 녹음합니다.', comments: [{ user: users.user1, text: "Prophet 스타일 베이스 사운드로 해보죠.", createdAt: '2024-06-08T10:00:00Z' }] },
    { id: 'task3', title: '드럼 패턴 편곡', status: 'todo', priority: 'medium', dueDate: '2024-06-15', assignees: [users.user1], description: '벌스와 코러스 드럼 패턴을 만듭니다.', comments: [] },
    { id: 'task4', title: '보컬 믹싱', status: 'todo', priority: 'low', dueDate: '2024-06-20', assignees: [users.user3], description: '보컬 트랙을 처리하고 믹싱합니다.', comments: [] },
];

const projectFiles: ProjectFile[] = [
    { id: 'file1', name: '메인_신스_리드.wav', type: 'audio', url: '#', uploadedBy: users.user1, uploadedAt: '2024-06-10T14:00:00Z', version: 2 },
    { id: 'file2', name: '프로젝트_개요.pdf', type: 'document', url: '#', uploadedBy: users.user1, uploadedAt: '2024-06-05T09:00:00Z', version: 1 },
];

const projectMessages: StudioProjectMessage[] = [
    { id: 'pm1', user: users.user1, text: "팀 여러분, 이 프로젝트를 시작합시다! 먼저 메인 멜로디부터요.", createdAt: '2024-06-05T09:05:00Z' },
    { id: 'pm2', user: users.user2, text: "좋아요! 베이스라인 아이디어를 구상해볼게요.", createdAt: '2024-06-05T09:10:00Z' },
];

export const sampleStudioProjects: StudioProject[] = [
    { id: 'proj1', title: '사이버펑크 드림', description: '미래 도시를 위한 어두운 신스웨이브 트랙.', status: 'recording', tags: ['신스웨이브', '사이버펑크', '80년대'], contributors: [{ user: users.user1, role: '프로듀서' }, { user: users.user2, role: '베이스' }, { user: users.user3, role: '보컬' }], lastUpdatedAt: new Date().toISOString(), progress: 45, isPublic: false, tasks: projectTasks, files: projectFiles, messages: projectMessages },
    { id: 'proj2', title: '오케스트라 피날레', description: '영화 스코어를 위한 웅장한 오케스트라 곡.', status: 'mixing', tags: ['시네마틱', '오케스트라'], contributors: [{ user: users.user5, role: '작곡가' }], lastUpdatedAt: '2024-06-08T11:00:00Z', progress: 75, isPublic: false, tasks: [], files: [], messages: [] },
    { id: 'proj3', title: '공개 로파이 잼', description: '편안한 로파이 트랙을 만드는 커뮤니티 프로젝트. 누구나 참여할 수 있습니다!', status: 'planning', tags: ['로파이', '커뮤니티', '잼'], contributors: [{ user: users.user2, role: '리드' }, { user: users.user4, role: '패드' }], lastUpdatedAt: '2024-06-07T18:00:00Z', progress: 10, isPublic: true, tasks: [], files: [], messages: [] },
    { id: 'proj4', title: '앨범 마스터링', description: '곧 나올 "디지털 노스탤지어" 앨범의 최종 마스터링.', status: 'completed', tags: ['마스터링', '앨범'], contributors: [{ user: users.user1, role: '엔지니어' }], lastUpdatedAt: '2024-05-20T10:00:00Z', progress: 100, isPublic: false, tasks: [], files: [], messages: [] },
];

export const sampleTeams: Team[] = [
    { id: 'team1', name: '신스웨이브 연합', description: '진정한 80년대 감성의 신스웨이브 음악을 만드는 팀.', members: [{ user: users.user1, role: 'Admin' }, { user: users.user4, role: 'Member' }], projectIds: ['proj1'], createdAt: '2023-01-15T10:00:00Z' },
    { id: 'team2', name: '스코어 작곡가들', description: '영화, TV, 게임을 위한 웅장한 음악을 만듭니다.', members: [{ user: users.user5, role: 'Admin' }], projectIds: ['proj2'], createdAt: '2023-02-20T11:00:00Z' },
];
...
export const samplePortfolioProjects: PortfolioProject[] = [
  {
    ...
    title: '레트로 푸투라',
    description: `
**프로젝트 목표:** 80년대 SF 영화 사운드트랙을 연상시키는 클래식 신스웨이브 트랙 만들기.
