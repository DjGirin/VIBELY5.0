...
type Page = 'stage' | 'friends' | 'music' | 'settings' | 'messages' | 'profile' | 'community' | 'threadDetail' | 'followList' | 'projectDetail' | 'dashboard' | 'projects' | 'teams' | 'studio' | 'ai_tools' | 'backstage';
  ...
  return (
    <NotificationProvider>
      <div className="bg-light-bg min-h-screen text-light-text-primary font-sans">
        <Header onNavigateToMyProfile={handleNavigateToMyProfile} />
