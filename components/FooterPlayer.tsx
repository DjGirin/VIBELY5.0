...
import { SkipBackIcon, PlayIcon, PauseIcon, SkipForwardIcon, Volume2Icon, VolumeXIcon, RepeatIcon, ListPlus, ChevronUpIcon, HeartIcon } from './icons';
...
const FooterPlayer: React.FC<FooterPlayerProps> = ({
  ...
  return (
    <>
      {/* 다크 테마 미니 플레이어 */}
      <footer className="fixed bottom-0 md:bottom-0 left-0 right-0 z-40 transition-all duration-300">
        {/* 진행 바 (상단) */}
        ...
        <div className="bg-gray-900/95 backdrop-blur-lg border-t border-gray-800 h-16 md:h-20 flex items-center px-3 md:px-4">
          ...
          {/* 볼륨 컨트롤 (우측) */}
          <div className="hidden md:flex flex-none w-40 items-center justify-end space-x-2">
